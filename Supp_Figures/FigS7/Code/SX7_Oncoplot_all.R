...
pdf("Supp. Figures/Oncoplot/S1_oncoplot_all_genes.pdf", width = 7.5, height = 10,  useDingbats=FALSE,  pointsize = 9)
...
oncoplot(laml.maf, top = 100,
         ...
         titleFontSize = 1, 
         topBarData = "n_rep_ind", gene_mar = 20, colors = yarrr::piratepal(palette = "xmen"), 
         pathways = pathways, 
         bgCol = "grey90",
